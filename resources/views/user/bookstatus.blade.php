    ...
    <section id="reservation-form" class="mt50 clearfix">
     ...
     <br><br><br><br>   <form class="reservation-vertical clearfix" action="#" role="form" method="post" name="reservationform" id="reservationform">
          ...
          <div class="form-group{{ $errors->has('checkin') ? ' has-error' : '' }}">
            ...
            <input name="checkin" type="text" id="checkin" value="" class="form-control" placeholder="Check-in" required autofocus/>
          ...
          <div class="form-group">
            ...
            <i class="fa fa-calendar infield"></i>
            <input name="checkout" type="text" id="checkout" value="" class="form-control" placeholder="Check-out" required autofocus/>
          </div>
          <div class="form-group">
    			...
    			<div class="panel-body">
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						<thead>
                                <tr>
                                    <td class="text-center"><strong>Full Names</strong></td>
        							<td class="text-center"><strong>Mobile Number</strong></td>
            						<td class="text-center"><strong>Hotel</strong></td>
                                    ...
                                    <td class="text-right"><strong>Payment type</strong></td>
                                </tr>
    						</thead>
    						<tbody>
    							<!-- foreach ($order->lineItems as $line) or some such thing here -->
    							<tr>
                                    <td class="text-center">{{$bookstatus->fname}} {{$bookstatus->lname}}</td>
    								<td  class="text-center">{{$bookstatus->mobileno}}</td>
    								<td class="text-center">{{$bookstatus->hotel}} </td>
                                    <td class="text-center">{{$bookstatus->rtype}}</td>
    								<td class="text-center">{{$bookstatus->noofrooms}}</td>
                                    <td class="text-center">{{$bookstatus->checkin}}</td>
                                    <td class="text-center">{{$bookstatus->checkout}}</td>
                                    <td class="text-center">{{$bookstatus->totalp}}</td>
                                    <td class="text-center">{{$bookstatus->status}}</td>
                                    <td class="text-center">{{$bookstatus->ptype}}</td>
    							</tr>
